...
overlaps, but his baseline position is high and he is involved in the attack
continuously.

**He is also the best for passes into the area in its position** 0.67 completed open-play
...
3rd of 13 (77th percentile). He does not just enter the final third, but his passes
...
- **League choice.** The Indian Super League 2021/22 was the only competition in
  the available open data with full-season coverage (115 matches, 11 teams). 
...
- **Normalisation & ranking.** All metrics are per-90 and expressed as percentiles
  *within this league only*. No cross-league comparison is made, as that would
...
- **Number of minutes.** His 946 minutes is one of the lowest in the pool, making his 
percentiles one of the least stable of the group.
...
1. **Defending.** This report is offence-only. A full-back must also defend. His
